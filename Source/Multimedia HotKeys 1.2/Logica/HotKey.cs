...
namespace Logica
{
    public class HotKey
    {
        ...
        {
            return datosHotKey.ReadByKeysPressed(keyPressed);
        }
            ...
            foreach (var hk in hotKeysList)
            {
                ...
                foreach (var hkItem in hotKeysList)
                {
                    ...
                    if ((hkCurrent == hkCompared) && (hk.Name != hkItem.Name))
                    {
                        ...
                        Modelo.HotKey hkNew = new Modelo.HotKey(hkItem.Name, hkItem.Key);
        ...
        public string ReplacehkPressedText(Modelo.HotKey hkSelected)
        {
            ...
            if (hkSelected.Key == "Add")
                hkSelected.Key = "+";
            hotKeyPressedText = "Ctrl + Alt +" + hkSelected.Key;
